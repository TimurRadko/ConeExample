...
public class ConeObservableIdComparatorTest {
    ...
    private static final ConeObservable FIRST_CONE_OBSERVABLE = new ConeObservable(FIRST_CONE, 2);
    ...
    private static final ConeObservable SECOND_CONE_OBSERVABLE = new ConeObservable(SECOND_CONE, 1);
    private Comparator<ConeObservable> comparator;

    @Before
    public void createComparator() {
        comparator = new ConeObservableIdComparator();
    }

    @Test
    public void testCompareShouldReturnCorrectResultWhenFirstObjectMoreThenSecond() {
